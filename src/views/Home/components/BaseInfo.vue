  ...
  <section id="section-home" class="bg-white dark:bg-gray-900">
    ...
    >
      <div class="mr-auto place-self-center lg:col-span-7">
        <h1
          class="max-w-2xl mb-4 text-2xl font-extrabold leading-none tracking-tight md:text-5xl dark:text-white"
        >
          {{ t("baseInfo.title") }}
        </h1>
        <p
        ...
        <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <a
            href="https://github.com/Geocld/XStreaming"
            target="_blank"
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img class="h-30" :src="logo" alt="hero image" />
      </div>
    </div>
  </section>
</template>
